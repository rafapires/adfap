...
<?php } ?>
<input type="file" name="file<?php echo $field['id'] ?>[]" id="field_<?php echo $field['field_key'] ?>" <?php do_action('frm_field_input_html', $field) ?> onchange="frmNextUpload(jQuery(this),<?php echo $field['id'] ?>,'<?php _e('Remove', 'formidable') ?>')" />
<?php  
    }else{ ?>
