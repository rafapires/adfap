...
<tr><td colspan="2"><input type="checkbox" name="options[single_entry]" id="single_entry" value="1"<?php echo ($values['single_entry'])?(' checked="checked"'):(''); ?> /> <label for="single_entry"><?php _e('Allow Only One Entry for Each', 'formidable') ?></label>
