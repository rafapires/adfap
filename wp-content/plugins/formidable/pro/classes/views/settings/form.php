<tr class="form-field">
    ...
    <td>        
        ...
        <input type="text" id="frm_already_submitted" name="frm_already_submitted" class="frm_long_input" value="<?php echo esc_attr($frmpro_settings->already_submitted) ?>" />
    </td>
</tr>
...
<table class="form-table">
    <tr class="form-field">
        ...
        <td class="frm_sample_form">
            ...
            <p class="submit">
            <input type="submit" disabled="disabled" value="<?php echo esc_attr( __('Submit', 'formidable')) ?>" />
            </p>
            </div>
        </td>    
    </tr> 